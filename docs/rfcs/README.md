...
| [0003](0003-ssh-tool.md) | `SshCallTool` (asyncssh) | Draft | 0.3 | Agent tool for running commands over SSH. Depends on RFC 0002 for auth. Ships under `loom[ssh]` extras. |
